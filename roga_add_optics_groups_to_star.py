...
if __name__ == '__main__':
    ...
    if args.save_csv:
        ...
        df_optics_out.to_csv(os.path.splitext(args.output_star)[0] + '_optics.csv', index=False)
        df_particles_out.to_csv(os.path.splitext(args.output_star)[0] + '_paritcles.csv', index=False)
